...
This document provides guidelines for internationalization of the Chita Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `chita_en.ts` remains unchanged.
