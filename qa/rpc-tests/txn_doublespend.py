...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 12,500 CHI:
        ...
        # First: use raw transaction API to send 12400 CHI to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 CHI coin each
        ...
        # Node0's balance should be starting balance, plus 500CHI for another
        ...
        # Node0's total balance should be starting balance, plus 1000CHI for
