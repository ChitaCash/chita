...
Arguments:
    <base_directory> - The base directory of a Chita Core source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Chita Core developers'
...
Arguments:
    <base_directory> - The base directory of Chita Core source code repository.
"""
...
Arguments:
    <file> - A source file in the Chita Core repository.
"""
