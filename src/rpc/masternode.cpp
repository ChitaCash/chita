...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Chita address\n"
            "  payee          - Print the masternode payout Chita address (can be additionally filtered,\n"
            "                   partial match)\n"
            "  pubKeyOperator - Print the masternode operator public key\n"
            "  status         - Print masternode status: ENABLED / POSE_BANNED\n"
            "                   (can be additionally filtered, partial match)\n"
            "  votingaddress  - Print the masternode voting Chita address\n"
        );
}
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "chita",               "masternode",             &masternode,             true,  {} },
    { "chita",               "masternodelist",         &masternodelist,         true,  {} },
    { "chita",               "getpoolinfo",            &getpoolinfo,            true,  {} },
#ifdef ENABLE_WALLET
    { "chita",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
