...
from test_framework.test_framework import ChitaTestFramework
...
class LLMQCoinbaseCommitmentsTest(ChitaTestFramework):
    def __init__(self):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as ChitaTestFramework doesn't support this atm)
