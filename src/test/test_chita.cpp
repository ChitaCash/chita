...
#define BOOST_TEST_MODULE Chita Test Suite

#include "test_chita.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_chita_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
