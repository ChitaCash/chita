...
This mechanism has been integrated into Bitcore-Node-Chita which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/chitapay/insight-api-chita#web-socket-api](https://github.com/chitapay/insight-api-chita#web-socket-api)
* API: [https://github.com/chitapay/insight-api-chita#instantsend-transactions](https://github.com/chitapay/insight-api-chita#instantsend-transactions)
