...
official/supported Docker Images found at https://hub.docker.com/r/chitapay/chitad/
...
**NOTE: Please update the image description at https://hub.docker.com/r/chitapay/chitad-develop/ when changing the above text**